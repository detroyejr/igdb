#' IGDB Characters
#'
#' Search for a list of characters from the IGDB API.
#'
#' @md
...
#' @examples
#' \dontrun{
#' igdb_characters(search = "master chief")
#' }
#' @seealso [IGDB API](https://igdb.github.io/api/about/welcome/)
#'
#' @export
igdb_characters <- function(search = NULL, id = NULL, n = 50, limit = 50,
