#' IGDB Franchises
#'
#' Search for a list of franchises from the IGDB API.
#'
#' @md
...
#' @examples
#' igdb_franchises(search = "call of duty")
#'
#' @seealso [IGDB API](https://igdb.github.io/api/about/welcome/)
#'
#' @export
igdb_franchises <- function(search = NULL, id = NULL, n = 50, limit = 50,
