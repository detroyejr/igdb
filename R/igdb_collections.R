#' IGDB Collections
#'
#' Search for a list of collections from the IGDB API.
#'
#' @md
...
#'
#' @export
igdb_collections <- function(search = NULL, id = NULL, n = 50, limit = 50,
  ...
  date_cols <- c("created_at", "updated_at", "start_date")
