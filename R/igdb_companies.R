#' IGDB Companies
#'
#' Search for a list of companies from the IGDB API.
#'
#' @md
...
#' @examples
#' \dontrun{
#' igdb_companies(search = "ea")
#' }
#' @seealso [IGDB API](https://igdb.github.io/api/about/welcome/)
#'
#' @export
igdb_companies <- function(search = NULL, id = NULL, n = 50, limit = 50,
