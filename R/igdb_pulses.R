#' IGDB Pulses
#'
#' Search for a list of new articles from the IGDB API.
#'
#' @md
...
#' @examples
#' \dontrun{
#' igdb_pulses(search = "activision")
#' }
#'
#' @seealso [IGDB API](https://igdb.github.io/api/about/welcome/)
#'
#' @export
igdb_pulses <- function(search = NULL, id = NULL, n = 50, limit = 50,
