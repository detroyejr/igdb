#' IGDB Reviews
#'
#' Search for a list of reviews from the IGDB API.
#'
#' @md
#' @param search a keyword or title.
...
#'
#' @export
igdb_reviews <- function(search = NULL, id = NULL, n = 50, limit = 50,
