#' IGDB Platform
#'
#' Search for a list of platform information from the IGDB API.
#'
#' @md
...
#' @examples
#' igdb_platform(search = "xbox")
#'
#' @seealso [IGDB API](https://igdb.github.io/api/about/welcome/)
#'
#' @export
igdb_platform <- function(search = NULL, id = NULL, n = 50, limit = 50,
